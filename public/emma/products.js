...
const PRODUCTS = [
...

  {
    ...
    imageHover:    'images/unicorn1-hover.png',
    price:         7.00,
    originalPrice: 10.00,
    onSale:        true,
    translations: {
...

  {
    ...
    imageHover:    'images/unicorn-face-hover.png',
    price:         7.00,
    originalPrice: 10.00,
    onSale:        true,
    translations: {
...

  {
    ...
    imageHover:    'images/unicorn2-hover.png',
    price:         7.00,
    originalPrice: 10.00,
    onSale:        true,
    translations: {
...

  {
    ...
    imageHover:    'images/unicorn3-hover.png',
    price:         7.00,
    originalPrice: 10.00,
    onSale:        true,
    translations: {
...

  {
    id:            'dinosaur-kit-1',
    category:      'dinosaur',
    image:         'images/dinosaur1.png',
    imageHover:    'images/dinosaur1-hover.png',
    price:         10.00,
    originalPrice: null,
    onSale:        false,
    translations: {
...

  {
    id:            'dinosaur-kit-2',
    category:      'dinosaur',
    image:         'images/dinosaur2.png',
    imageHover:    'images/dinosaur2-hover.png',
    price:         7.00,
    originalPrice: 10.00,
    onSale:        true,
    translations: {
